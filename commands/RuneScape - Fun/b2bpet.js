...
module.exports = class extends Command {
	...
	async run(msg, [petName]) {
		switch (petName
			...
			case 'MOLE':
			case 'BABYMOLE':
				return msg.send(`You had to kill ${this.petRoll(3000)} Giant Moles to get the Baby Mole Pet **Back-to-Back (2 in a row)!** <:Baby_mole:324127375858204672>`);
			case 'BLOODHOUND':
				return msg.send(`You had to complete ${this.petRoll(1000)} Master Clues to get the Bloodhound Pet **Back-to-Back (2 in a row)!** <:Bloodhound:324127375602483212>`);
			case 'CALLISTO':
			case 'CALLISTOCUB':
			case 'CUB':
				return msg.send(`You had to slay Callisto ${this.petRoll(2000)} times to get the Callisto Cub Pet **Back-to-Back (2 in a row)!** <:Callisto_cub:324127376273440768>`);
			case 'KALPHITE':
			...
			case 'DAWN':
			case 'GG':
				return msg.send(`You had to kill ${this.petRoll(3000)} Grotesque Guardians to get the Noon Pet **Back-to-Back (2 in a row)!** <:Noon:379595337234382848>`);
			case 'OLMLET':
			case 'OLM':
			case 'RAIDS':
			...
			case 'ARMADYL':
			case 'KREEARRA':
				return msg.send(`You had to kill Kree'arra ${this.petRoll(5000)} times to get the Kree'arra Pet **Back-to-Back (2 in a row)!** <:Pet_kreearra:324127377305239555>`);
			case 'KRIL':
			case 'ZAMMY':
			case 'ZAMORAK':
			...
			case 'SARADOMIN':
			case 'ZILYANA':
				return msg.send(`You had to kill Commander Zilyana ${this.petRoll(5000)} times to get the Zilyana Jr. Pet **Back-to-Back (2 in a row)!** <:Pet_zilyana:324127378248957952>`);
			case 'PHOENIX':
			case 'WINTERTODT':
			case 'FIREMAKING':
				return msg.send(`You had to open ${this.petRoll(5000)} Wintertodt Supply Crates to get the Phoenix Pet **Back-to-Back (2 in a row)!** <:Phoenix:324127378223792129>`);
			case 'KBD':
			...
			case 'CERBERUS':
			case 'HELLPUPPY':
				return msg.send(`You had to kill Cerberus ${this.petRoll(3000)} times to get the Hellpuppy Pet **Back-to-Back (2 in a row)!** <:Hellpuppy:324127376185491458>`);
			case 'CHOMPYCHICK':
				return msg.send(`You had to kill ${this.petRoll(500)} Chompy Birds to get the Chompy Chick Pet **Back-to-Back (2 in a row)!** <:Chompy_chick:346196885859598337>`);
			case 'INFERNO':
			case 'NIBBLER':
				return msg.send(`You had to complete the Inferno ${this.petRoll(100)} times to get the Jal-Nib-Rek Pet **Back-to-Back (2 in a row)!** <:Jalnibrek:346196886119514113>`);
			case 'HERBI':
			case 'HERBIBOAR':
				return msg.send(`You had to track down ${this.petRoll(6500)} Herbiboars to get the Herbi Pet **Back-to-Back (2 in a row)!** <:Herbi:357773175318249472>`);
			case 'VORKI':
			case 'VORKATH':
				return msg.send(`You had to slay the almighty Vorkath ${this.petRoll(3000)} times to get the Vorki Pet **Back-to-Back (2 in a row)!** <:Vorki:400713309252222977>`);
			case 'LILZIK':
			case 'RAIDS2':
			case 'ZIK':
				return msg.send(`You had to complete the Theatre of Blood ${this.petRoll(650)} times to get the Lil' Zik pet **Back-to-Back (2 in a row)!** <:Lil_zik:479460344423776266>`);
			default:
				return msg.send("Invalid pet name. Skilling pets aren't available for this command.");
		}
	}
	petRoll(dropChance) {
		let hasPet = false;
