// Copyright kyranet @ https://gist.github.com/kyranet/4542edf4679ff1a6a8fe6bf94909ac9d
	...
	async run() {
		...
		this.client.console.log(
			`${HEADER} ${this.setColor(presences)} [Presence]s | ${this.setColor(guildMembers)} [GuildMember]s | ${this.setColor(
				users
			)} [User]s | ${this.setColor(emojis)} [Emoji]s | ${this.setColor(lastMessage)} [Last Message]s.`
		);
	}
