...
// 	const buttonCollector = message.createMessageComponentCollector({ componentType: ComponentType.Button });
// 	expectAssignable<Promise<ButtonInteraction>>(
// 		message.awaitMessageComponent({ componentType: ComponentType.Button })
// 	);
// 	expectAssignable<Promise<ButtonInteraction>>(
// 		channel.awaitMessageComponent({ componentType: ComponentType.Button })
// 	);
...
// 		expectType<[ReadonlyCollection<Snowflake, ButtonInteraction>, string]>(args)
// 	);
...
// 	expectType<string | null>(answer.text);
// 	expectType<Emoji | null>(answer.emoji);
// 	expectType<number>(answer.id);
// 	expectType<number>(answer.voteCount!);
// });
...
// {
// 	expectType<Promise<VoiceChannel>>(
// 		categoryChannelChildManager.create({ name: 'name', type: ChannelType.GuildVoice })
// 	);
...
// 	expectType<Promise<AnyThreadChannel | null>>(
...
// 	expectType<Promise<ThreadMember<true>>>(
// 		threadMemberManager.fetch({ member: '12345678901234567', withMember: true })
// 	);
...
// 			expectType<Promise<InteractionCallbackResponse<true>>>(
// 				interaction.reply({ content: 'a', withResponse: true })
// 			);
...
// 			expectType<Promise<InteractionCallbackResponse<true>>>(
// 				interaction.update({ content: 'a', withResponse: true })
// 			);
...
// 			expectType<Promise<InteractionCallbackResponse<false>>>(
// 				interaction.reply({ content: 'a', withResponse: true })
// 			);
...
// 		} else if (interaction.inGuild()) {
// 			expectType<APIInteractionGuildMember | GuildMember | null>(interaction.targetMember);
// 			expectType<APIInteractionDataResolvedGuildMember | GuildMember | null>(
...
// 			expectType<APIInteractionDataResolvedChannel | GuildBasedChannel>(
...
// expectType<
// 	AnnouncementChannel | CategoryChannel | ForumChannel | MediaChannel | TextChannel
// >(NonThreadGuildBasedChannel);
