		...
		return (
			<div className="relative">
				...
				<button
					...
					className={cn(
						'peer inline-flex h-7 w-14 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2',
						...
						isChecked ? 'bg-blue-500' : 'bg-neutral-300/20',
						className
					)}
				>
					<span
