...
export const PyrefiendPreTable: LootTable = new LootTable()
	/* Weapons and armour */
	.add('Steel axe', 1, 4)
...
const PyrefiendTable: LootTable = new LootTable()
...
export const Pyrefiend: SimpleMonster = new SimpleMonster({
	id: 433,
	name: 'Pyrefiend',
