...
const ticketTable = new SimpleTable<number>()
	.add(1, 8) // 2 tickets are earned if the player's team loses.
	.add(2, 8) // 2 tickets are earned if scores are tied at 0-0.
	.add(3, 5) // 3 tickets are earned if scores are tied at any number other than 0.
	.add(3, 5) // 3 tickets are earned for winning if the opposing team has scored.
