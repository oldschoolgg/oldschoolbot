...
function shouldApplyBoost(clueTierName['name'], item: string, hasAchievementDiaryCape: boolean) {
	switch (clueTierName) {
		case Elite:
...
function applyClueBoosts(user: MUser, boostList: ClueBoost[], boosts: any[], duration: number, clueTierName['name']) {
