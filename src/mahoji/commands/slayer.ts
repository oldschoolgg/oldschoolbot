...
import type { CommandOption } from '@/discord/commands/commandOptions.js';
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				required: false,
				autocomplete: async (ctx: Parameters<typeof slayerMonsterAutocomplete>[0]) =>
					slayerMonsterAutocomplete(ctx)
			}
		]
	},
	{
