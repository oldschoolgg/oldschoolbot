...
export async function championsChallengeCommand(KlasaUser: KlasaUser, channelID: bigint) {
	...
	return `${KlasaUser.minionName} is now doing the Champion's Challenge! Removed 1x of every Champion scroll from your bank.`;
}
