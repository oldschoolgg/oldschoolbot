...
export interface StashUnitTier {
	tier: ClueTier['name'];
	plank: 'normal' | 'oak' | 'teak' | 'mahogany';
	extraCost?: Bank;
...
export const mediumStashes: StashUnitTier = {
	...
	units: [
		...
		},
		{
			...
			items: resolveItems(['Ruby amulet', 'Mithril scimitar', 'Team cape'])
		},
		{
			id: 36,
		...
		},
		{
			id: 39,
			desc: 'Shantay Pass',
			items: resolveItems(['Pointed bruise blue snelm', 'Staff of air', 'Bronze sq shield'])
		},
		{
			id: 40,
		...
		},
		{
			...
			items: resolveItems(["Green d'hide chaps", 'Ring of dueling', 'Mithril med helm'])
		},
		{
			id: 47,
			desc: 'Barbarian Outpost obstacle course (centre)',
			items: resolveItems(['Steel platebody', 'Maple shortbow', 'Team cape'])
		},
		{
			id: 48,
...
export const hardStashes: StashUnitTier = {
	...
	units: [
		...
		{ id: 60, desc: 'Shilo Village bank', items: resolveItems(['Mystic hat', 'Bone spear', 'Rune platebody']) },
		{
			...
			items: resolveItems(['Rune heraldic shield', 'Stole'])
		},
		{
			id: 62,
			desc: 'In the middle of Jiggig',
			items: resolveItems(['Rune spear', 'Rune platelegs', 'Rune heraldic helm'])
		},
		{
			id: 63,
		...
		{ id: 69, desc: 'Volcano in the north-eastern Wilderness', items: resolveItems(['Headband', 'Crozier']) },
		{ id: 70, desc: 'Agility Pyramid', items: resolveItems(['Mystic robe top', 'Rune heraldic shield']) }
	]
};
...
export const eliteStashes: StashUnitTier = {
	...
	units: [
		...
		},
		{
			...
			items: resolveItems(['Mystic robe bottom', 'Rune kiteshield', 'Bob shirt'])
		},
		{
			id: 78,
			desc: 'Near the gem stall in Ardougne Market',
			items: resolveItems(['Castle wars bracelet', 'Dragonstone amulet', 'Ring of forging'])
		},
		{
			id: 79,
		...
		},
		{
			...
			items: resolveItems(['Rune crossbow', 'Climbing boots', 'Mitre'])
		},
		{
			id: 82,
			desc: 'South-east corner of the Monastery (next to Edgeville, on the ground floor)',
			items: resolveItems(['God book'])
		},
		{
			id: 83,
			desc: 'Outside the Slayer Tower gargoyle room (top floor)',
			items: resolveItems(['Seercull', 'Combat bracelet', 'Helm of neitiznot'])
		},
		{
			id: 84,
			desc: "Fountain of Heroes (under the Heroes' Guild)",
...
export const masterStashes: StashUnitTier = {
	...
	xp: 1500,
	extraCost: new Bank().add('Gold leaf'),
	units: [
		{
			id: 88,
		...
		{ id: 89, desc: 'Barrows chest', items: resolveItems(['Any set of Barrows equipment']) },
		{
			id: 90,
			desc: 'On top of the Northern wall of Castle Drakan',
			items: resolveItems(['Boater', 'Splitbark body', 'Dragon sq shield'])
		},
