...
export const constructionLevelUpTable = [
	{
		lvl: 1,
		messages: ['build a Crude wooden chair'],
	...
	{
		lvl: 9,
		messages: ['build a Wooden larder'],
		skill: SkillsEnum.Construction
	},
	{
		lvl: 10,
	...
	{
		lvl: 15,
		messages: ['build a Repair bench'],
		skill: SkillsEnum.Construction
	},
	{
		lvl: 16,
		messages: ['build a Crafting table 1'],
		skill: SkillsEnum.Construction
	},
	{
		lvl: 19,
		messages: ['build an Oak chair'],
		skill: SkillsEnum.Construction
	},
	{
		lvl: 22,
	...
	{
		lvl: 50,
		messages: ['build a Mahogany armchair'],
		skill: SkillsEnum.Construction
	},
	{
		lvl: 52,
		messages: ['build a Mahogany table', 'build a Mahogany bench'],
		skill: SkillsEnum.Construction
	},
	{
		lvl: 66,
		messages: ['build a Teak garden bench'],
		skill: SkillsEnum.Construction
	},
	{
		lvl: 74,
		messages: ['build an Oak door'],
		skill: SkillsEnum.Construction
	},
	{
		lvl: 77,
		messages: ['build a Gnome bench'],
		skill: SkillsEnum.Construction
	},
	{
		lvl: 99,
		messages: ['buy the Construction cape and hood'],
		skill: SkillsEnum.Construction
	}
];
