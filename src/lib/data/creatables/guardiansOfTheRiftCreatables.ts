...
export const guardiansOfTheRiftCreatables: Createable[] = [
	// Red Recolours
	{
		name: 'Amulet of the eye (red)',
		inputItems: new Bank({ 'Amulet of the eye': 1, 'Abyssal red dye': 1 }),
		outputItems: new Bank({ 'Amulet of the eye (red)': 1 })
	},
	{
	...
	{
		name: 'Lost bag (red)',
		inputItems: new Bank({ 'Lost bag': 1, 'Abyssal red dye': 1 }),
		outputItems: new Bank({ 'Lost bag (red)': 1 })
	},
	{
	...
	// Green Recolours
	{
		name: 'Amulet of the eye (green)',
		inputItems: new Bank({ 'Amulet of the eye': 1, 'Abyssal green dye': 1 }),
		outputItems: new Bank({ 'Amulet of the eye (green)': 1 })
	},
	{
	...
	{
		name: 'Lost bag (green)',
		inputItems: new Bank({ 'Lost bag': 1, 'Abyssal green dye': 1 }),
		outputItems: new Bank({ 'Lost bag (green)': 1 })
	},
	{
	...
	// Blue Recolours
	{
		name: 'Amulet of the eye (blue)',
		inputItems: new Bank({ 'Amulet of the eye': 1, 'Abyssal blue dye': 1 }),
		outputItems: new Bank({ 'Amulet of the eye (blue)': 1 })
	},
	{
	...
	{
		name: 'Lost bag (blue)',
		inputItems: new Bank({ 'Lost bag': 1, 'Abyssal blue dye': 1 }),
		outputItems: new Bank({ 'Lost bag (blue)': 1 })
	},
	{
