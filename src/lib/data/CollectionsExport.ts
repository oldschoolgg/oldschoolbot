...
export const archonCL = resolveItems(['Prismare ring (u)', 'Empyrean shards', "Archon's ichor", 'Archibald']);
export const elderCacheCL = resolveItems(['Elderflame catalyst', 'Archon relic']);
