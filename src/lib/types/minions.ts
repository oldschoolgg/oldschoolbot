...
export interface FarmingStepTaskData {
	duration: number;
	pid?: number;
...
export interface FarmingActivityTaskOptions extends ActivityTaskOptions, FarmingStepTaskData {
	type: 'Farming';
	autoFarmed: boolean;
...
export interface YamaActivityTaskOptions extends ActivityTaskOptions {
	type: 'Yama';
	quantity: number;
	iQty?: number;
	leader: string;
