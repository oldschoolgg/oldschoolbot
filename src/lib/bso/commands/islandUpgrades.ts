...
export const ASSIGNMENT_BOOST = 1.3;
export const ASSIGNMENT_PENALTY = 0.8;
...
function tierRelevanceFactor(itemMinLevel: number, tier: number): number {
	...
	if (itemMinLevel >= midpoint) return 1.0;
...
export const upgradeCategoryMeta: Record<UpgradeCategory, UpgradeCategoryMeta> = {
	...
	mining: {
		label: 'Excavation Tunnels',
		locationName: 'the Excavation Tunnels',
	...
	divination: {
		label: 'Divination Spire',
		locationName: 'the Divination Spire',
	...
	farming: {
		...
		locationName: 'the Fertile Fields',
...
export const upgradeDefinitions: Record<UpgradeCategory, UpgradeTier[]> = {
	boss: [
		...
		},
		{
			...
			flavorText: 'The sentinel cores see everything.'
		},
		{
			tier: 5,
			cost: new Bank()
	...
	megaboss: [
		{
			...
			flavorText: 'Brimstone and rune-etched stones. Something stirs.'
		},
		{
			tier: 2,
			cost: new Bank()
			...
			flavorText: 'The Archon gives more freely now.'
		},
		{
			tier: 3,
			cost: new Bank()
			...
			flavorText: 'Nothing the Archon holds can stay hidden.'
		},
		{
			tier: 4,
			cost: new Bank()
			...
			flavorText: 'The Archon has no secrets left.'
		},
		{
			tier: 5,
			cost: new Bank()
			...
			flavorText: 'The sanctum is complete.'
		}
	],
	...
	minigame: [
		...
		},
		{
			...
			flavorText: 'Traders are finding their way here.'
		},
		{
			tier: 4,
			cost: new Bank()
			...
			flavorText: 'The settlement practically runs itself.'
		},
		{
			tier: 5,
			cost: new Bank()
	...
	gathering: [
		...
		},
		{
			...
			flavorText: "The terrain doesn't slow them anymore."
		},
		{
			tier: 3,
			cost: new Bank()
	...
	prismare: [
		{
			...
			bonus: '+0.5% global XP',
			flavorText: 'The prismare shard levitates and spins.'
		},
		{
			tier: 2,
			cost: new Bank()
		...
		},
		{
			...
			bonus: '+1.5% global XP',
			flavorText: 'Everything on the island feels sharper.'
		},
		{
			tier: 4,
			cost: new Bank()
	...
	fishing: [
		{
			...
			bonus: 'Passively accumulates fish up to level 40',
			flavorText: 'The docks are in a state. But the lines are in the water.'
		},
		{
			tier: 2,
			cost: new Bank()
			...
			bonus: 'Passively accumulates fish up to level 60',
			flavorText: 'Steel frames and yew hulls. The serious fishing begins.'
		},
		{
			tier: 3,
			cost: new Bank()
			...
			bonus: 'Passively accumulates fish up to level 75',
			flavorText: 'The deep water gives up its catches now.'
		},
		{
			tier: 4,
			cost: new Bank()
			...
			bonus: 'Passively accumulates fish up to level 90',
			flavorText: 'Nothing in these waters is safe from the nets now.'
		},
		{
			tier: 5,
			cost: new Bank()
			...
			bonus: 'Passively accumulates fish up to level 120',
			flavorText: 'The sea has no secrets from the docks now.'
		}
	],
	...
	mining: [
		{
			...
			bonus: 'Passively accumulates ore up to level 40',
			flavorText: 'Dim lanterns and shallow shafts. A start.'
		},
		{
			tier: 2,
			cost: new Bank()
			...
			bonus: 'Passively accumulates ore up to level 60',
			flavorText: 'Steel props and better lanterns. The crews dig deeper.'
		},
		{
			tier: 3,
			cost: new Bank()
			...
			bonus: 'Passively accumulates ore up to level 75',
			flavorText: 'The real seams begin here.'
		},
		{
			tier: 4,
			cost: new Bank()
			...
			bonus: 'Passively accumulates ore up to level 90',
			flavorText: 'The island bleeds ore. You just have to dig deep enough.'
		},
		{
			tier: 5,
			cost: new Bank()
			...
			bonus: 'Passively accumulates ore up to level 120',
			flavorText: 'The tunnels have a heartbeat now.'
		}
	],
	...
	woodcutting: [
		{
			...
			bonus: 'Passively accumulates logs up to level 40',
			flavorText: 'Crude but effective. The timber flows slowly.'
		},
		{
			tier: 2,
			cost: new Bank()
			...
			bonus: 'Passively accumulates logs up to level 60',
			flavorText: 'Steel saws and seasoned crews. The teak stands are falling.'
		},
		{
			tier: 3,
			cost: new Bank()
			...
			bonus: 'Passively accumulates logs up to level 75',
			flavorText: "The magic trees don't hold out for long."
		},
		{
			tier: 4,
			cost: new Bank()
			...
			bonus: 'Passively accumulates logs up to level 90',
			flavorText: 'Redwood falls like any other tree now.'
		},
		{
			tier: 5,
			cost: new Bank()
			...
			bonus: 'Passively accumulates logs up to level 120',
			flavorText: 'The island itself seems to offer up its wood now.'
		}
	],
	...
	divination: [
		{
			...
			bonus: 'Passively accumulates energy up to level 40',
			flavorText: 'A faint shimmer. The spire is waking.'
		},
		{
			tier: 2,
			cost: new Bank()
			...
			bonus: 'Passively accumulates energy up to level 60',
			flavorText: 'Golden light at the apex. The scholars are excited.'
		},
		{
			tier: 3,
			cost: new Bank()
			...
			bonus: 'Passively accumulates energy up to level 75',
			flavorText: 'The air tastes different near the spire now.'
		},
		{
			tier: 4,
			cost: new Bank()
			...
			bonus: 'Passively accumulates energy up to level 90',
			flavorText: 'The hum carries through the ground now.'
		},
		{
			tier: 5,
			cost: new Bank()
			...
			bonus: 'Passively accumulates energy up to level 120 including prismare',
			flavorText: 'The spire no longer needs tending. It tends itself.'
		}
	],
	...
	farming: [
		{
			...
			bonus: 'Passively accumulates crops up to level 40',
			flavorText: 'Dirt under the fingernails. The plots are growing.'
		},
		{
			tier: 2,
			cost: new Bank()
			...
			bonus: 'Passively accumulates crops up to level 60',
			flavorText: 'The herb rows are fragrant this week. A good sign.'
		},
		{
			tier: 3,
			cost: new Bank()
			...
			bonus: 'Passively accumulates crops up to level 75',
			flavorText: 'The magic watering cans keep the plots thriving.'
		},
		{
			tier: 4,
			cost: new Bank()
			...
			bonus: 'Passively accumulates crops up to level 90',
			flavorText: 'Dragon fruit and torstol. The plots smell extraordinary.'
		},
		{
			tier: 5,
			cost: new Bank()
			...
			bonus: 'Passively accumulates crops up to level 120',
			flavorText: 'The island grows things here that grow nowhere else.'
		}
	]
};
...
function applyAssignmentMultiplier(base: number, category: UpgradeCategory, active: AssignableCategory | null): number {
...
export function getBossSpeedBonus(
	...
	return applyAssignmentMultiplier([0, 0.05, 0.1, 0.15, 0.2, 0.25][tier] ?? 0, 'boss', resolveAssignment(t, a));
}

export function getMinigameRewardBonus(
	u: Partial<IslandUpgradeTiers>,
	t?: IslandMaintenanceTimestamps,
	a?: AssignableCategory | null
): number {
	...
	return applyAssignmentMultiplier([0, 0.05, 0.1, 0.15, 0.2, 0.25][tier] ?? 0, 'minigame', resolveAssignment(t, a));
}

export function getGatheringSpeedBonus(
	u: Partial<IslandUpgradeTiers>,
	t?: IslandMaintenanceTimestamps,
	a?: AssignableCategory | null
): number {
	...
	return applyAssignmentMultiplier([0, 0.05, 0.1, 0.15, 0.2, 0.25][tier] ?? 0, 'gathering', resolveAssignment(t, a));
}

export function getPrismareXPBonus(
	u: Partial<IslandUpgradeTiers>,
	t?: IslandMaintenanceTimestamps,
	a?: AssignableCategory | null
): number {
	...
	return applyAssignmentMultiplier(
		[0, 0.005, 0.01, 0.015, 0.02, 0.025][tier] ?? 0,
		'prismare',
		resolveAssignment(t, a)
	);
}

export function getMegabossLootBonus(
	u: Partial<IslandUpgradeTiers>,
	t?: IslandMaintenanceTimestamps,
	a?: AssignableCategory | null
): number {
