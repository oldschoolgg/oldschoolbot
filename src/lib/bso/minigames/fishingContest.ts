...
export const fishingLocations: FishingLocation[] = [
	// Rivers
	{
		...
		bait: Items.getOrThrow('Raw beast meat')
	},
	{
		id: 2,
		name: 'River Salve',
		...
		bait: Items.getOrThrow('Unicorn horn')
	},
	{
		id: 3,
		name: 'River Dougne',
		...
		bait: Items.getOrThrow('Red salamander')
	},
	{
		id: 4,
		name: 'River Lum',
		...
		bait: Items.getOrThrow('Raw beef')
	},
	// Oceans
	{
		id: 7,
		...
		bait: Items.getOrThrow('Snowy knight')
	},
	{
		id: 8,
		...
		bait: Items.getOrThrow('Chinchompa')
	},
	// Lakes
	{
		id: 10,
		...
		bait: Items.getOrThrow('Orange feather')
	},
	{
		id: 11,
		...
		bait: Items.getOrThrow('Mort myre fungus')
	},
	{
		id: 12,
		...
		bait: Items.getOrThrow('Infernal eel')
	}
];
