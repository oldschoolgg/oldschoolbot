import { randArrItem, randInt, roll, toTitleCase } from '@oldschoolgg/toolkit';
...
export const monkeyTiers: MonkeyTier[] = [
	{
		id: 1,
		name: 'Beginner',
		greegrees: [Items.getOrThrow('Beginner rumble greegree')],
	...
	},
	{
		id: 2,
		name: 'Intermediate',
		greegrees: [Items.getOrThrow('Intermediate rumble greegree')],
	...
	},
	{
		id: 3,
		name: 'Ninja',
		greegrees: [Items.getOrThrow('Ninja rumble greegree')],
	...
	},
	{
		id: 4,
		name: 'Expert Ninja',
		greegrees: [Items.getOrThrow('Expert ninja rumble greegree')],
	...
	},
	{
		id: 5,
		name: 'Elder',
		greegrees: [Items.getOrThrow('Elder rumble greegree'), Items.getOrThrow('Gorilla rumble greegree')],
...
export const monkeyEatables: MonkeyEatable[] = [
	{ item: Items.getOrThrow('Lychee'), boost: 9 },
	{ item: Items.getOrThrow('Mango'), boost: 6 },
	{ item: Items.getOrThrow('Avocado'), boost: 3 },
	{ item: Items.getOrThrow('Coconut') },
	{ item: Items.getOrThrow('Dragonfruit') },
	{ item: Items.getOrThrow('Banana') },
	{ item: Items.getOrThrow('Orange') },
	{ item: Items.getOrThrow('Pineapple') },
	{ item: Items.getOrThrow('Strawberry') },
	{ item: Items.getOrThrow('Watermelon') },
	{ item: Items.getOrThrow('Tomato') },
	{ item: Items.getOrThrow('Papaya fruit') },
	{ item: Items.getOrThrow('Grapes') },
	{ item: Items.getOrThrow('Lemon') },
	{ item: Items.getOrThrow('Lime') },
	{ item: Items.getOrThrow('Peach') }
];
