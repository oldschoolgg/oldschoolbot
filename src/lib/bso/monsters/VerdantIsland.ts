...
export const CrystallineSentinelLootTable = new LootTable()
	.every('Bones')
...
export const FungalBehemothLootTable = new LootTable()
	.tertiary(150, 'Clue scroll (medium)')
	.tertiary(250, 'Clue scroll (hard)')
...
export const OrymLootTable = new LootTable()
...
export const BurningDominionLootTable = new LootTable()
...
export const Orym: CustomMonster = {
	...
	pohBoosts: {
		pool: { 'Ancient rejuvenation pool': 5 }
	},
	deathProps: {
		hardness: 0.4,
		steepness: 0.999,
	...
	equippedItemBoosts: [
		{
			gearSetup: 'melee',
			items: [{ boostPercent: 25, itemID: itemID('Dragonbane glaive') }]
		},
		{
			gearSetup: 'melee',
			items: [{ boostPercent: 15, itemID: itemID('Dragonbane aegis') }]
		},
		{
			gearSetup: 'melee',
...
export const BurningDominionTemplate: CustomMonster = {
	...
	respawnTime: 0,
	difficultyRating: 9,
	table: BurningDominionLootTable,
	qpRequired: 2500,
