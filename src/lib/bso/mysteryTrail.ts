...
export const mysteriousStepData = {
	1: {
		clueItem: Items.getOrThrow('Dungsoaked message'),
	...
	2: {
		clueItem: Items.getOrThrow('Mysterious clue (2)'),
	...
	5: {
		clueItem: Items.getOrThrow('Mysterious clue (5)'),
	...
	6: {
		clueItem: Items.getOrThrow('Mysterious clue (6)'),
