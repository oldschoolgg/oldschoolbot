...
export const tameFeedableItems: FeedableItem[] = [
	...
	{
		item: Items.getOrThrow('Abyssal cape'),
	...
	{
		item: Items.getOrThrow('Ring of endurance'),
		description: '10% faster collecting',
		tameSpeciesCanBeFedThis: [TameSpeciesID.Monkey],
		announcementString:
	...
	{
		item: Items.getOrThrow('Dwarven warhammer'),
	...
	{
		item: Items.getOrThrow('Impling locator'),
	...
	{
		item: Items.getOrThrow('Elder knowledge'),
...
export const seaMonkeyStaves = [
	{
		tier: 1,
		item: Items.getOrThrow('Seamonkey staff (t1)'),
	...
	{
		tier: 2,
		item: Items.getOrThrow('Seamonkey staff (t2)'),
	...
	{
		tier: 3,
		item: Items.getOrThrow('Seamonkey staff (t3)'),
...
export const igneArmors = [
	{
		item: Items.getOrThrow('Dragon igne armor'),
		coxDeathChance: 85,
		foodReduction: 5,
		nightmareDeathChance: 55
	},
	{
		item: Items.getOrThrow('Barrows igne armor'),
		coxDeathChance: 75,
		foodReduction: 8,
		nightmareDeathChance: 33
	},
	{
		item: Items.getOrThrow('Volcanic igne armor'),
		coxDeathChance: 65,
		foodReduction: 10,
		nightmareDeathChance: 15
	},
	{
		item: Items.getOrThrow('Justiciar igne armor'),
		coxDeathChance: 50,
		foodReduction: 15,
		nightmareDeathChance: 8
	},
	{
		item: Items.getOrThrow('Drygore igne armor'),
		coxDeathChance: 30,
		foodReduction: 22,
		nightmareDeathChance: 4
	},
	{
		item: Items.getOrThrow('Dwarven igne armor'),
		coxDeathChance: 10,
		foodReduction: 27,
		nightmareDeathChance: 1.5
	},
	{
		item: Items.getOrThrow('Gorajan igne armor'),
		coxDeathChance: 5,
		foodReduction: 33,
...
export const tameSpecies: Species[] = [
	...
	},
	{
		...
		egg: Items.getOrThrow('Monkey egg'),
	...
	},
	{
		...
		hatchTime: Time.Hour * 4.5,
		egg: Items.getOrThrow('Eagle egg'),
