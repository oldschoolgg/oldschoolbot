...
export const finishables: Finishable[] = [
	...
	},
	{
		...
		kill: () => {
			if (roll(35)) {
				return EliteMimicTable.roll().add(EliteClueTable.roll(1));
			}
			return EliteClueTable.roll(1);
		}
	},
	{
		...
		kill: () => {
			if (roll(15)) {
				return MasterMimicTable.roll().add(MasterCasket.roll(1));
			}
			return MasterCasket.roll(1);
		}
	},
	{
