...
export const cluesRares = {
  ...
  '3rd Age Ring': transformArrayOfResolvableItems([
    'Ring of 3rd age'
  ]),
  Gilded: transformArrayOfResolvableItems([
    'Gilded full helm',
...
export const cluesAll = Object.assign({}, cluesShared, cluesRares, cluesEasy, cluesMedium, cluesHard, cluesElite, cluesMaster);
