...
Client.defaultUserSchema
	...
	.add('minion', folder =>
		folder
			...
			.add('meleeAttackStyle', 'string', { default: null })
			.add('rangeAttackStyle', 'string', { default: null })
			.add('mageAttackStyle', 'string', { default: null })
			.add('castedSpell', 'string', { default: null })
			.add('combatSkill', 'string', { default: null })
			.add('meleeCombatStyle', 'string', { default: null })
			.add('rangeCombatStyle', 'string', { default: null })
			.add('mageCombatStyle', 'string', { default: null })
			.add('combatSpell', 'string', { default: null })
	)
