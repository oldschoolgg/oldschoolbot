...
export namespace ClientSettings {
	...
	export namespace EconomyStats {
		...
		export const ItemSellTaxBank = T<number>(
			"economyStats.itemSellTaxBank"
		);
		export const BankBgCostBank = T<Readonly<ItemBank>>(
			"economyStats.bankBgCostBank"
		);
		export const SacrificedBank = T<Readonly<ItemBank>>(
			"economyStats.sacrificedBank"
		);

		export const WintertodtCost = T<Readonly<ItemBank>>(
			"economyStats.wintertodtCost"
		);
		export const WintertodtLoot = T<Readonly<ItemBank>>(
			"economyStats.wintertodtLoot"
		);
		export const FightCavesCost = T<Readonly<ItemBank>>(
			"economyStats.fightCavesCost"
		);
		export const PVMCost = T<Readonly<ItemBank>>("economyStats.PVMCost");
		export const ThievingCost = T<Readonly<ItemBank>>(
			"economyStats.thievingCost"
		);
		export const SoldItemsBank = T<Readonly<ItemBank>>("sold_items_bank");
		export const HerbloreCostBank =
			T<Readonly<ItemBank>>("herblore_cost_bank");
		export const ConstructCostBank = T<Readonly<ItemBank>>(
			"construction_cost_bank"
		);
		export const FarmingCostBank =
			T<Readonly<ItemBank>>("farming_cost_bank");
		export const FarmingLootBank =
			T<Readonly<ItemBank>>("farming_loot_bank");
		...
		export const GnomeRestaurantCostBank =
			T<Readonly<ItemBank>>("gnome_res_cost");
		export const GnomeRestaurantLootBank =
			T<Readonly<ItemBank>>("gnome_res_loot");

		export const RoguesDenStaminas =
			T<Readonly<ItemBank>>("rogues_den_cost");
		...
		export const ItemContractCost =
			T<Readonly<ItemBank>>("item_contract_cost");
		export const ItemContractLoot =
			T<Readonly<ItemBank>>("item_contract_loot");
		...
		export const TameMergingCost =
			T<Readonly<ItemBank>>("tame_merging_cost");
		export const TripDoublingLoot =
			T<Readonly<ItemBank>>("trip_doubling_loot");
		...
		export const DegradedItemsCost = T<Readonly<ItemBank>>(
			"degraded_items_cost"
		);
