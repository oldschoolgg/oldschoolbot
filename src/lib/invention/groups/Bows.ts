...
export const Bows: DisassemblySourceGroup = {
	...
	items: [
		...
		{ item: i('Willow shortbow'), lvl: 30 },
		{ item: i('Willow longbow'), lvl: 35 },
		{ item: i('Willow comp bow'), lvl: 40 },
		{ item: i('Comp ogre bow'), lvl: 45 },
		{ item: i('Maple shortbow'), lvl: 50 },
		{ item: i('Maple longbow'), lvl: 55 },
		{ item: i('Yew shortbow'), lvl: 65 },
		{ item: i('Yew longbow'), lvl: 70 },
		{ item: i('Yew comp bow'), lvl: 70 },
		{ item: i('Magic shortbow'), lvl: 75 },
		{ item: i('Magic longbow'), lvl: 80 },
		{ item: i('Elder bow'), lvl: 85 },
