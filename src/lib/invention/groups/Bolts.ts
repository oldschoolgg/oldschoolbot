...
export const Bolts: DisassemblySourceGroup = {
	name: 'Bolts',
	items: [
		{ item: i('Barbed bolts'), lvl: 1 },
		{ item: i('Bronze bolts'), lvl: 1 },
		{ item: i('Iron bolts'), lvl: 5 },
		{ item: i('Opal bolts'), lvl: 5 },
		{ item: i('Blurite bolts'), lvl: 8 },
		{ item: i('Steel bolts (unf)'), lvl: 8 },
		{
			item: i('Black brutal'),
			lvl: 10,
		...
		{ item: i('Mithril bolts'), lvl: 15 },
		{ item: i('Pearl bolts (e)'), lvl: 15 },
		{ item: i('Steel bolts (p+)'), lvl: 15 },
		...
		{ item: i('Kebbit bolts'), lvl: 25 },
		{ item: i('Long kebbit bolts'), lvl: 25 },
		{ item: i('Ruby bolts'), lvl: 25 },
		{ item: i('Sapphire bolts (e)'), lvl: 25 },
		{ item: i('Diamond bolts'), lvl: 30 },
		{ item: i('Dragon bolts'), lvl: 30 },
