...
export const Longsword: DisassemblySourceGroup = {
	name: 'Longsword',
	items: [
		{ item: i('Blurite sword'), lvl: 1 },
		{ item: i('Fremennik blade'), lvl: 1 },
		{ item: i('Jade machete'), lvl: 1 },
		{ item: i('Machete'), lvl: 1 },
		{ item: i('Opal machete'), lvl: 1 },
		{ item: i('Red topaz machete'), lvl: 1 },
		{ item: i('Teasing stick'), lvl: 1 },
		{
			item: i('Wooden spoon'),
			lvl: 1,
			special: { always: false, parts: [{ type: 'culinary', chance: 100, amount: 8 }] }
		},
		{ item: i("Harry's cutlass"), lvl: 20 },
		{
		...
		{ item: i('Excalibur'), lvl: 30 },
		{ item: i('Lucky cutlass'), lvl: 30 },
		{
			item: i('Skewer'),
			lvl: 30,
			special: { always: false, parts: [{ type: 'culinary', chance: 100, amount: 8 }] }
