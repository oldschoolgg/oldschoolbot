...
export const rewardsGuardianTable = new LootTable()
	...
	/* Runes */
	.add('Chaos rune', [61, 150], 16)
	.add('Cosmic rune', [20, 30], 16)
	.add('Nature rune', [28, 150], 16)
	.add('Law rune', [9, 120], 16)
	.add('Death rune', [5, 120], 16)
	.add('Blood rune', [5, 120], 16)
	.add('Air rune', [400, 500], 16)
	.add('Water rune', [400, 500], 16)
	.add('Earth rune', [400, 500], 16)
	.add('Fire rune', [400, 500], 16)
	.add('Mind rune', [250, 400], 16)
	.add('Body rune', [80, 150], 16)
