...
const HerbloreTable = new LootTable()
	...
	.add('Grimy irit leaf', [5, 10])
	.add('Grimy avantoe', [5, 10])
	.add('Grimy kwuarm', [5, 10])
	.add('Grimy cadantine', [5, 10])
	.add('Grimy dwarf weed', [5, 10])
	.add('Grimy torstol', [5, 10])
	.add('Grimy lantadyme', [5, 10])
	.add('Grimy toadflax', [5, 10])
	.add('Grimy snapdragon', [5, 10]);

const HerbloreSecondariesTable = new LootTable()
	.add('Limpwurt root', [10, 40])
	.add('Volcanic Ash', [10, 40])
	.add("Red spiders' eggs", [10, 40])
	.add('White berries', [10, 40])
	.add("Toad's legs", [10, 40])
	.add('Goat horn dust', [10, 40])
	.add('Snape grass', [10, 40])
	.add('Mort myre fungus', [10, 40])
	.add('Dragon scale dust', [10, 40])
	.add('Yew roots', [10, 40])
	.add('Wine of zamorak', [10, 40])
	.add('Potato cactus', [10, 40])
	.add('Magic roots', [10, 40])
	.add('Crushed nest', [10, 40])
	.add('Poison ivy berries', [10, 40]);
