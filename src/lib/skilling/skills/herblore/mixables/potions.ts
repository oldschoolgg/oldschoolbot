...
const Potions: Mixable[] = [
	...
	{
		item: Items.getOrThrow('Vial of blood'),
	...
	{
		item: Items.getOrThrow('Heat res. brew'),
	...
	{
		item: Items.getOrThrow('Heat res. restore'),
	...
	{
		item: Items.getOrThrow('Enhanced saradomin brew'),
	...
	{
		item: Items.getOrThrow('Enhanced super restore'),
	...
	{
		item: Items.getOrThrow('Enhanced stamina potion'),
	...
	{
		item: Items.getOrThrow('Enhanced divine water'),
	...
	{
		item: Items.getOrThrow('Divination potion'),
