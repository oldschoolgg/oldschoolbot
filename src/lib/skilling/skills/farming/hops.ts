...
const hopsPlants: Plant[] = [
	{
		...
		checkXp: 0,
		harvestXp: 9.5,
		inputItems: new Bank({ 'Barley seed': 4 }),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank({ Compost: 3 }),
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 10,
		inputItems: new Bank({ 'Hammerstone seed': 4 }),
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 12,
		inputItems: new Bank({ 'Asgarnian seed': 4 }),
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 14.5,
		inputItems: new Bank({ 'Jute seed': 3 }),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank({ 'Barley malt': 6 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 16,
		inputItems: new Bank({ 'Yanillian seed': 4 }),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank({ 'Tomatoes(5)': 200 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 19.5,
		inputItems: new Bank({ 'Krandorian seed': 4 }),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank({ 'Cabbages(10)': 3 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 26,
		inputItems: new Bank({ 'Wildblood seed': 4 }),
		...
		chance99: 183,
		chanceOfDeath: 25,
		protectionPayment: new Bank({ Nasturtiums: 1 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
