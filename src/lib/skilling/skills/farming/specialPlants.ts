...
const specialPlants: Plant[] = [
	{
		...
		checkXp: 64,
		harvestXp: 4.5,
		inputItems: new Bank({ 'Redberry seed': 1 }),
		...
		protectionPayment: new Bank({ Cabbage: 20 }),
	...
	},
	{
		...
		checkXp: 102.5,
		harvestXp: 7,
		inputItems: new Bank({ 'Cadavaberry seed': 1 }),
		...
		chance99: 154.9,
		chanceOfDeath: 17, // needs data
		protectionPayment: new Bank({ Tomato: 15 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 21,
		inputItems: new Bank({ 'Seaweed spore': 1 }),
		...
		chance99: 208,
		chanceOfDeath: 20,
		protectionPayment: new Bank({ Numulite: 200 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 120,
		inputItems: new Bank({ 'Limpwurt seed': 1 }),
	...
	},
	{
		...
		checkXp: 7290,
		harvestXp: 0,
		inputItems: new Bank({ 'Teak seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 15,
		protectionPayment: new Bank({ 'Limpwurt root': 15 }),
		woodcuttingXp: 85,
	...
	},
	{
		...
		checkXp: 625,
		harvestXp: 40,
		inputItems: new Bank({ 'Grape seed': 1, Saltpetre: 1 }),
	...
	},
	{
		...
		checkXp: 177.5,
		harvestXp: 12,
		inputItems: new Bank({ 'Dwellberry seed': 1 }),
		...
		chance99: 154.9,
		chanceOfDeath: 17, // needs data
		protectionPayment: new Bank({ Strawberry: 15 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 284.5,
		harvestXp: 19,
		inputItems: new Bank({ 'Jangerberry seed': 1 }),
		...
		chance99: 154.9,
		chanceOfDeath: 17, // needs data
		protectionPayment: new Bank({ Watermelon: 6 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 57.7,
		inputItems: new Bank({ 'Mushroom spore': 1 }),
	...
	},
	{
		...
		checkXp: 374,
		harvestXp: 25,
		inputItems: new Bank({ 'Cactus seed': 1 }),
		...
		chance99: 178.2,
		chanceOfDeath: 15,
		protectionPayment: new Bank({ 'Cadava berries': 6 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 15_720,
		harvestXp: 0,
		inputItems: new Bank({ 'Mahogany seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 12,
		protectionPayment: new Bank({ 'Yanillian hops': 25 }),
		woodcuttingXp: 125,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
	...
	},
	{
		...
		checkXp: 437.5,
		harvestXp: 29,
		inputItems: new Bank({ 'Whiteberry seed': 1 }),
		...
		chance99: 154.9,
		chanceOfDeath: 15,
		protectionPayment: new Bank({ Mushroom: 8 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 0,
		harvestXp: 512,
		inputItems: new Bank({ 'Belladonna seed': 1 }),
	...
	},
	{
		...
		checkXp: 230,
		harvestXp: 68,
		inputItems: new Bank({ 'Potato cactus seed': 1 }),
		...
		chance99: 154.9,
		chanceOfDeath: 12,
		protectionPayment: new Bank({ 'Snape grass': 8 }),
		needsChopForHarvest: false,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 12_600,
		harvestXp: 0,
		inputItems: new Bank({ 'Hespori seed': 1 }),
		name: 'Hespori',
		aliases: ['hespori'],
		petChance: 7000,
		seedType: 'hespori',
	...
	},
	{
		...
		checkXp: 675,
		harvestXp: 45,
		inputItems: new Bank({ 'Poison ivy seed': 1 }),
	...
	},
	{
		...
		checkXp: 12_096,
		harvestXp: 48.5,
		inputItems: new Bank({ 'Calquat tree seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 17,
		protectionPayment: new Bank({ 'Poison ivy berries': 8 }),
		needsChopForHarvest: true,
		fixedOutput: true,
		fixedOutputAmount: 6,
		givesLogs: false,
	...
	},
	{
		...
		checkXp: 13_240,
		harvestXp: 0,
		inputItems: new Bank({ 'Crystal acorn': 1 }),
	...
	},
	{
		...
		checkXp: 19_301,
		harvestXp: 0,
		inputItems: new Bank({ 'Spirit seed': 1 }),
		treeWoodcuttingLevel: 1,
		name: 'Spirit tree',
	...
	},
	{
		...
		checkXp: 14_130,
		harvestXp: 23.5,
		inputItems: new Bank({ 'Celastrus seed': 1 }),
		...
		chance99: 63,
		chanceOfDeath: 15,
		protectionPayment: new Bank({ 'Potato cactus': 8 }),
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: false,
		givesCrops: true,
	...
	},
	{
		...
		checkXp: 22_450,
		harvestXp: 0,
		inputItems: new Bank({ 'Redwood tree seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 8,
		protectionPayment: new Bank({ Dragonfruit: 6 }),
		woodcuttingXp: 380,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
