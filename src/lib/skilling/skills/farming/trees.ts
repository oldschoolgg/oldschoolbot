...
const trees: Plant[] = [
	{
		...
		protectionPayment: new Bank({ 'Tomatoes(5)': 1 }),
		woodcuttingXp: 37.5,
	...
	},
	{
		...
		inputItems: new Bank({ 'Willow seed': 1 }),
	...
	},
	{
		...
		inputItems: new Bank({ 'Maple seed': 1 }),
		...
		protectionPayment: new Bank({ 'Oranges(5)': 1 }),
		woodcuttingXp: 100,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
	...
	},
	{
		...
		inputItems: new Bank({ 'Yew seed': 1 }),
		...
		protectionPayment: new Bank({ 'Cactus spine': 10 }),
		woodcuttingXp: 175,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
	...
	},
	{
		...
		inputItems: new Bank({ 'Magic seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 8 / 128,
		protectionPayment: new Bank({ Coconut: 25 }),
		woodcuttingXp: 250,
		needsChopForHarvest: true,
		fixedOutput: false,
		givesLogs: true,
