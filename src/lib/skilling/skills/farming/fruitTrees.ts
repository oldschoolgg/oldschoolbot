...
const fruitTrees: Plant[] = [
	{
		...
		inputItems: new Bank({ 'Apple tree seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 17,
		protectionPayment: new Bank({ Sweetcorn: 9 }),
	...
	},
	{
		...
		inputItems: new Bank({ 'Banana tree seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 17,
		protectionPayment: new Bank({ 'Apples(5)': 4 }),
		treeWoodcuttingLevel: 1,
		fixedOutputAmount: 6,
		woodcuttingXp: 0,
		needsChopForHarvest: true,
	...
	},
	{
		...
		inputItems: new Bank({ 'Orange tree seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 17,
		protectionPayment: new Bank({ 'Strawberries(5)': 3 }),
		treeWoodcuttingLevel: 1,
		fixedOutputAmount: 6,
		woodcuttingXp: 0,
		needsChopForHarvest: true,
	...
	},
	{
		...
		inputItems: new Bank({ 'Curry tree seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 17,
		protectionPayment: new Bank({ 'Bananas(5)': 5 }),
		treeWoodcuttingLevel: 1,
		fixedOutputAmount: 6,
		woodcuttingXp: 0,
		needsChopForHarvest: true,
	...
	},
	{
		...
		inputItems: new Bank({ 'Pineapple seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 17,
		protectionPayment: new Bank({ Watermelon: 10 }),
		treeWoodcuttingLevel: 1,
		fixedOutputAmount: 6,
		woodcuttingXp: 0,
		needsChopForHarvest: true,
	...
	},
	{
		...
		inputItems: new Bank({ 'Papaya tree seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 17,
		protectionPayment: new Bank({ Pineapple: 10 }),
		treeWoodcuttingLevel: 1,
		fixedOutputAmount: 6,
		woodcuttingXp: 0,
		needsChopForHarvest: true,
	...
	},
	{
		...
		inputItems: new Bank({ 'Palm tree seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 17,
		protectionPayment: new Bank({ 'Papaya fruit': 15 }),
		treeWoodcuttingLevel: 1,
		fixedOutputAmount: 6,
		woodcuttingXp: 0,
		needsChopForHarvest: true,
	...
	},
	{
		...
		inputItems: new Bank({ 'Dragonfruit tree seed': 1 }),
		...
		chance99: 0,
		chanceOfDeath: 17,
		protectionPayment: new Bank({ Coconut: 15 }),
		treeWoodcuttingLevel: 1,
		fixedOutputAmount: 6,
		woodcuttingXp: 0,
		needsChopForHarvest: true,
