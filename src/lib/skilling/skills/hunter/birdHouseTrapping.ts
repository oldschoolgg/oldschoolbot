...
const birdHouses: BirdHouse[] = [
    {
        ...
        table: new LootTable().every('Raw bird meat').tertiary(2, NestBoxes).tertiary(3, 'Feather', 10),
    ...
    },
    {
        ...
        table: new LootTable().every('Raw bird meat').tertiary(2, NestBoxes, [1, 2]).tertiary(3, 'Feather', 10),
        huntTechnique: 'bird house trapping',
        waitTime: 50 * Time.Minute,
        runTime: 73 * Time.Second,
        qpRequired: 3
    },
    {
        ...
        table: new LootTable().every('Raw bird meat').tertiary(2, NestBoxes, [1, 3]).tertiary(3, 'Feather', 10),
        huntTechnique: 'bird house trapping',
        waitTime: 50 * Time.Minute,
        runTime: 73 * Time.Second,
        qpRequired: 3
    },
    {
        ...
        table: new LootTable().every('Raw bird meat').tertiary(2, NestBoxes, [1, 4]).tertiary(3, 'Feather', 10),
        huntTechnique: 'bird house trapping',
        waitTime: 50 * Time.Minute,
        runTime: 73 * Time.Second,
        qpRequired: 3
    },
    {
        ...
        table: new LootTable().every('Raw bird meat').tertiary(2, NestBoxes, [1, 5]).tertiary(3, 'Feather', 10),
        huntTechnique: 'bird house trapping',
        waitTime: 50 * Time.Minute,
        runTime: 73 * Time.Second,
        qpRequired: 3
    },
    {
        ...
        table: new LootTable().every('Raw bird meat').tertiary(2, NestBoxes, [1, 6]).tertiary(3, 'Feather', 10),
        huntTechnique: 'bird house trapping',
        waitTime: 50 * Time.Minute,
        runTime: 73 * Time.Second,
        qpRequired: 3
    },
    {
        ...
        table: new LootTable().every('Raw bird meat').tertiary(2, NestBoxes, [1, 7]).tertiary(3, 'Feather', 10),
        huntTechnique: 'bird house trapping',
        waitTime: 50 * Time.Minute,
        runTime: 73 * Time.Second,
        qpRequired: 3
    },
    {
        ...
        table: new LootTable().every('Raw bird meat').tertiary(2, NestBoxes, [1, 8]).tertiary(3, 'Feather', 10),
        huntTechnique: 'bird house trapping',
        waitTime: 50 * Time.Minute,
        runTime: 73 * Time.Second,
        qpRequired: 3
    },
    {
        ...
        table: new LootTable().every('Raw bird meat').tertiary(2, NestBoxes, [1, 9]).tertiary(3, 'Feather', 10),
        huntTechnique: 'bird house trapping',
        waitTime: 50 * Time.Minute,
        runTime: 73 * Time.Second,
        qpRequired: 3
