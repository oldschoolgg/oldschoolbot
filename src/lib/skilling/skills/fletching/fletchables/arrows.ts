...
const Arrows: Fletchable[] = [
	...
	},
	{
		...
		level: 5,
		xp: 9,
		inputItems: new Bank({ 'Ogre arrow shaft': 1, Feather: 4 }),
		tickRate: 0.13
	},
	{
		name: 'Ogre arrow',
	...
	{
		name: 'Elderflame arrow',
		id: itemID('Elderflame arrow'),
		level: 115,
		xp: 950,
		outputMultiple: 5,
		inputItems: new Bank({ 'Headless arrow': 1, 'Elderflame arrowtips': 1, 'Primordial scales': 1 }),
		tickRate: 0.13
	}
];
