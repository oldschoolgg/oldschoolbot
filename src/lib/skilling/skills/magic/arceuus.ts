...
const Arceuus: Castable[] = [
	...
	// },
	{
		...
		input: new Bank().add('Grimy guam leaf', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Guam leaf', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy marrentill', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Marrentill', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy tarromin', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Tarromin', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy harralander', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Harralander', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy ranarr weed', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Ranarr weed', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy toadflax', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Toadflax', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy irit leaf', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Irit leaf', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy avantoe', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Avantoe', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy kwuarm', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Kwuarm', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy snapdragon', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Snapdragon', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy cadantine', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Cadantine', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy lantadyme', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Lantadyme', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy dwarf weed', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Dwarf weed', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
		...
		input: new Bank().add('Grimy torstol', 27).add('Earth rune', 4).add('Nature rune', 2),
		output: new Bank().add('Torstol', 27),
		category: MagicTypes.Skilling,
		ticks: 8
	},
	{
