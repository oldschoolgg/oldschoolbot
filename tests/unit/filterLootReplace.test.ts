...
describe('filterLootReplace', () => {
	it('Should replace blugeon pieces when owning none', () => {
		const currentBank = new Bank().add('Twisted bow');
	...
	it('Should replace blugeon pieces', () => {
		const currentBank = new Bank().add('Twisted bow').add('Bludgeon spine');
	...
	it('Should replace hydra pieces', () => {
		const currentBank = new Bank().add('Twisted bow').add("Hydra's fang");
