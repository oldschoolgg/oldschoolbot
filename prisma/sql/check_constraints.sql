...
-- User (Skills)
SELECT add_constraint('users', 'agility_bounds', 'CHECK ("skills.agility" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'cooking_bounds', 'CHECK ("skills.cooking" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'fishing_bounds', 'CHECK ("skills.fishing" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'mining_bounds', 'CHECK ("skills.mining" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'smithing_bounds', 'CHECK ("skills.smithing" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'woodcutting_bounds', 'CHECK ("skills.woodcutting" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'firemaking_bounds', 'CHECK ("skills.firemaking" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'runecraft_bounds', 'CHECK ("skills.runecraft" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'crafting_bounds', 'CHECK ("skills.crafting" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'prayer_bounds', 'CHECK ("skills.prayer" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'fletching_bounds', 'CHECK ("skills.fletching" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'farming_bounds', 'CHECK ("skills.farming" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'herblore_bounds', 'CHECK ("skills.herblore" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'thieving_bounds', 'CHECK ("skills.thieving" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'hunter_bounds', 'CHECK ("skills.hunter" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'construction_bounds', 'CHECK ("skills.construction" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'magic_bounds', 'CHECK ("skills.magic" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'attack_bounds', 'CHECK ("skills.attack" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'strength_bounds', 'CHECK ("skills.strength" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'defence_bounds', 'CHECK ("skills.defence" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'ranged_bounds', 'CHECK ("skills.ranged" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'hitpoints_bounds', 'CHECK ("skills.hitpoints" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'slayer_bounds', 'CHECK ("skills.slayer" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'dungeoneering_bounds', 'CHECK ("skills.dungeoneering" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'invention_bounds', 'CHECK ("skills.invention" BETWEEN 0 AND 5000000000)');
SELECT add_constraint('users', 'divination_bounds', 'CHECK ("skills.divination" BETWEEN 0 AND 5000000000)');
...
SELECT add_constraint('xp_gains', 'xp_gains_bounds', 'CHECK (xp BETWEEN 0 AND 5000000000)');
