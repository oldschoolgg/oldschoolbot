...
- Spirit weed seed - Plat at 99 Farming in herb patch, gives [Spirit weed](herblore#divination-potion) when harvested.
...
- Advax berry seed - Plant at 111 Farming in bush patch, gives [Advax berry](herblore#divination-potion) when harvested.
...
- [Master Farming Outfit](/bso/custom-items/skilling-outfits/#master-farmer-outfit) - Gives +3 patches of all types. Obtained via crafting with 110 Crafting using Ent hides dropped from [Treebeard](/bso/monsters/demi-bosses/treebeard). Works from bank
- [Scroll of Life](dungeoneering-training/dg-rewards#buyable-boosts-utility) - 15% less seeds used when farming
- [Farming Master Cape](/bso/custom-items/capes/#master-capes) - Save 15% seeds. (50% if you have the cape and scroll of life); 1/10 chance per seed of a mystery box. +100% harvest
- 1500/3000 QP - Unlocks additional patches for custom crops
- [Plopper](/bso/custom-items/pets#miscellaneous-pets) - +100% harvest and crops can't die
- [Arcane Harvester](/bso/skills/invention/#inventions) - +100% increased yield - does not work on Mysterious Trees
- [[Moondash Charm]] - /use to gain 25% speed boost
