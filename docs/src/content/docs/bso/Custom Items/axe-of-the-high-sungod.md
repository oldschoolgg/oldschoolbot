---
title: "Axe of the High Sungod"
---

## Creation path

Create in this order with [[/create]]:
...
## Known effects in current BSO content

- [[Venatrix]]: +20% speed
- [[Akumu]]: +20% speed
- [[Vladimir Drakan]]: +10% speed (works from bank)
- [[Celestara]]: +25% speed (equipped boost)
- Colosseum: +40% in relevant calculations

Because boosts are activity-specific, check each boss/activity page for exact value.
