...
4. No alt accounts, you are only permitted to use the bot on 1 discord account per person, unless its an [ironman](ironman-mode), in which case it needs to be a permanent ironman.
