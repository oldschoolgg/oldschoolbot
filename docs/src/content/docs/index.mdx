...
For a guide on items you can buy from the bot and how shop pricing works, check out [Buyable Items and Shop Pricing Mechanics](./osb/Buyables/buyable-items-and-shop-pricing-mechanics).
