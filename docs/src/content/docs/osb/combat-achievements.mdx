...
You can complete almost all the same combat achievements in the bot as in the real game. However, the methods to obtain some achievements are different, as the bot simply cannot reflect the nature of all tasks.
