...
You can complete almost all the same combat achievements in the bot as in the real game. However, the method to obtain some achievements is different, as the bot simply cannot reflect the nature of all tasks. If there is a random chance to complete an achievement, it will be displayed ikn the below table. There may be further conditions, such as equipping specific items (typically allows any setup). 
