...
| Isle of Souls chest | 28 | 150 | 4,368 | - |
| Aldarin Villas chest | 36 | 200 | 18,748 | - |
...
XP/Hr is calculated using each chest's success chance and stun downtime where known; chests without success-rate data use the average 97.5% success rate from chest steals. Actual rates vary per trip.
