...
If you are tier 1 patron or higher, you can receive an **'Auto Farming Contract'** button after trip completions when your account is eligible to run it (for example, 45+ Farming and contract state allows an action). The same button can also appear in your minion status while idle. This can be enabled/disabled using: [[/config user toggle name\:Disable Auto Farm Contract Button]]
