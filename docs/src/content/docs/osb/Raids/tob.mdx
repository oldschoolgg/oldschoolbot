...
_- An uncharged scythe will still suffice, however, will only provide a 6% boost compared to the 15% the charged version gives. View [charging items here.](https://wiki.oldschool.gg/osb/miscelleanous/charging-items)
...
Your gear score serves only to raise your boost score. The exception to this is that you cannot go below 80% total gear score or 75% in a specific setup otherwise you will face huge penalties. Gear scores are always rounded up to the nearest whole number, i.e. 99.1% would be rounded to 100%.
...
For more information ([see Theory section below](./#Theory))
