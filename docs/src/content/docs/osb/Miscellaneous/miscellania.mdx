...
standard worker split, but you can customise these:
`[/simulate miscellania days:7 approval:80 woodcutting:5 mining:5]` would show a week of loot with 80%
approval and five workers on both woodcutting and mining.
