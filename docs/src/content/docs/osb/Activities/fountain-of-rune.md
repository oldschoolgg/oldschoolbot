...
You can start this activity using [[/activities charge]].
...
- You can remove charges using either:
  - [Gnome Restaurant](/osb/minigames/gnome-restaurant) (uses the glory during trips)
  - Glory uncharging (`/activities charge` options above)
