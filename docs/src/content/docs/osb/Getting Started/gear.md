...
If [[Avernic treads (max)]] are equipped in any Melee, Mage, or Range setup, they count as equipped in all three of those setups for combat checks. For gear stats and gear images, they only fill the feet slot if that setup has no boots equipped.
